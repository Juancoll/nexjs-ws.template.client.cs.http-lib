...
${nuget_cmd} install src/template.api.httpclient/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/template.api.httpclient.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/template.api.httpclient.dll \
-recurse:'src/template.api.httpclient/*.cs' \
-doc:bin/template.api.httpclient.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/template.api.httpclient.dll was created successfully"
fi
